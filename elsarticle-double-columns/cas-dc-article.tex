...
The selected human population was from the the rural area of Manaus, the capital of the state of Amazonas, between the years of 2004 to 2008, as it had the highest incidence of malaria 
caused by $P. \ vivax$ in the Amazon region \cite{Rorato2023}. This species of $\text{Plasmodium}$ was chosen as it is responsible for the highest number of malaria cases in Brazil \cite{OliveiraFerreira2010, 10.3389/fpubh.2021.647754}, being the most common human malaria 
...
approximately 0.5$\%$ of the municipality's population, while the number of cases in rural setting is about $30\%$ of all cases in Manaus in this 
period, and less than $1.5\%$ of the cases in the state.
