...
However, the use of these equations proved to be unsuccessful for the modelling of the mosquito populations through the SEI equations, which caused the 
function $\dfrac{dE_M}{dt}$ to be very close to 0, and therefore mirroring the oscillations of $S$ and $I$, a behavior not seen in nature. 
...
and a new parameter, $b_3$ to move mosquitos from $E$ to $I$. Being inversely related to the incubation period, the rate is defined as $b_3 = \dfrac{T-T_{min}}{DD}$. 
